...
const SHARED_CSS = `
    ...
    * { box-sizing: border-box; }
    ...
    .serif { font-weight: 600; letter-spacing: -0.035em; }
    ...
    .logo { font-size: 19px; font-weight: 600; letter-spacing: -0.035em; text-decoration: none; color: var(--ink); }
    .back { text-decoration: none; color: var(--ink-2); font-size: 14px; transition: color .2s; }
    .back:hover { color: var(--accent); }
    .nav-right { display: flex; gap: 16px; align-items: center; }
    .lang { font-family: "JetBrains Mono", monospace; font-size: 12px; color: var(--ink-3); text-decoration: none; border: 1px solid var(--line); padding: 4px 10px; border-radius: 999px; transition: all .2s; }
